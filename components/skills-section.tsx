...
const services = [
  {
    ...
    title: "AI Developer",
    description: "Creating intelligent AI chatbot system that help peoples solves their problems.",
  },
  {
  ...
  },
  {
    ...
    description: "Certified Electric Engineer with expertise in designing and implementing electrical systems.",
  },
  {
    icon: <LineChart className="w-10 h-10 text-pink-400" />,
    title: "Expert in Robotics",
    description: "Designing and building robots for various applications, from industrial automation to consumer products.",
  },
  {
    icon: <Globe className="w-10 h-10 text-pink-400" />,
    title: "E-commerce",
    description: "Experience in building and managing e-commerce platforms, ensuring smooth transactions and user experience.",
  },
  {
    icon: <Zap className="w-10 h-10 text-pink-400" />,
    title: "CIT",
    description: "Skilled in creating and managing IT systems, ensuring optimal performance and security.",
  },
]
